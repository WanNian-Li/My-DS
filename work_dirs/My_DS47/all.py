...
train_options = {
    ...
    'chart_loss': {  # Loss for the task
        ...
        'SOD': {
            ...
            'ignore_index': 255,
            'gamma': 1.5,
            'weight': [1, 1.0, 1.0, 1.8, 1.0],  # per-class alpha，5 classes (0-4)
        },
        'FLOE': {
    ...
    'val_downsample_scale': 10,  # 设为1：验证自动沿用down_sample_scale=10，与训练分辨率一致
    ...
    'water_rejection_prob': 0.90,    # 触发后以 80% 的概率丢弃该 patch
