...
train_options = {
    ...
    'chart_loss': {  # Loss for the task
        ...
        'SOD': {
            ...
            'weight': [0.8, 3.0, 2.0, 1.2, 1.0, 1.0],  # 6 classes (0-5)
        },
        'FLOE': {
            'type': 'CrossEntropyLoss',
            'ignore_index': 255,
...
# 
    'seed': 10,
    'epochs': 70,
    'epoch_len': 100,   # 每epoch采样200个batch，梯度估计更稳定
    ...
    'patch_size': 256,
    'batch_size':64,  # 从16提高至64：down_sample_scale=10时patch仅256×256，大batch才能填满GPU
    ...
    'rare_sampling_alpha': 0.7,       # 0=均匀采样, 1=完全按稀有类密度采样
